...
public class CommentDetailedItem : Comment
{
    ...
    public static Expression<Func<CommentEntity, CommentDetailedItem>> EntitySelector => p => new CommentDetailedItem
    {
        Id = p.Id,
        ...
        {
            ReplyContent = cr.ReplyContent, ReplyTimeUtc = cr.CreateTimeUtc
        }).ToList()
    };
}