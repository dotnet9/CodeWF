...
{
    public static BlogPostDetailDto? ConvertToBlogPostDetailDto(this BlogPost? blogPost, CodeWFDbContext dbContext)
    {
        if (blogPost == null)
        {
            return null;
    ...
    public static BlogPostDto? ConvertToBlogPostDto(this BlogPost? blogPost, CodeWFDbContext dbContext)
    {
        if (blogPost == null)
        {
            return null;
    ...
    public static BlogPostDto[]? ConvertToBlogPostDtoArray(this BlogPost[]? blogPosts, CodeWFDbContext dbContext)
    {
