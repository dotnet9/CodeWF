        ...
        baseInfo = new SiteBase
        {
            ...
            Menu = new List<MenuItem>
            {
                new MenuItem
                {
                    ...
                    Children = new List<MenuItem>
                    {
                        ...
                        {
                            Name = "二维码生成器",
                            Url = "https://tools.codewf.com/qrcode-generator",
                        },

                        new()
                        {
                            Name = "日期时间转换器",
                            Url = "https://tools.codewf.com/date-converter",
                        },

                        new()
                        {
                            Name = "整数基转换器",
                            Url = "https://tools.codewf.com/base-converter",
                        },
                        new()
                        {
                            Name = "打乱字符串",
                            Url = "https://tools.codewf.com/slugify-string",
                        }
                    }
                },
                new MenuItem
                {
                    ...
                    Children = new List<MenuItem>
                    {
                        ...
                        {
                            Name = ".NET",
                            Url = "https://blog.codewf.com/category/dotnet"
                        },
                        new()
                        {
                            Name = "分享",
                            Url = "https://blog.codewf.com/category/share"
                        },
                        new()
                        {
                            Name = "更多语言",
                            Url = "https://blog.codewf.com/category/morelanguage"
                        },
                        new()
                        {
                            Name = "课程",
                            Url = "https://blog.codewf.com/category/course"
                        },
                        new()
                        {
                            Name = "前端",
                            Url = "https://blog.codewf.com/category/frontend"
                        },
                        new()
                        {
                            Name = "数据库",
                            Url = "https://blog.codewf.com/category/database"
                        },
                        new()
                        {
                            Name = "Python",
                            Url = "https://blog.codewf.com/category/python"
                        },
                    }
                },
            },
            ...
            BlogPosts = new List<BlogPostItem>
            {
                new()
                {
                    ...
                    Cover = "https://img1.dotnet9.com/site/tools/clear.png",
                    Url =
                        "https://blog.codewf.com/post/2024/3/12/netbeauty2-let-your-dotnet-project-output-directory-is-more-refreshing"
                },
                new()
                {
                    ...
                    Cover = "https://img1.dotnet9.com/site/tools/avalonia-white-purple.svg",
                    Url =
                        "https://blog.codewf.com/post/2022/11/19/one-of-the-best-choices-for-dotnet-cross-platform-frameworks-avalonia-ui"
                },
                new()
                {
                    Title = "各版本操作系统对.NET支持情况",
                    Memo = "借助虚拟机和测试机，检测各版本操作系统对.NET的支持情况。安装操作系统后，实测安装相应运行时并能够运行星尘代理为通过。",
                    Cover = "https://img1.dotnet9.com/site/tools/dotnet.png",
                    Url =
                        "https://blog.codewf.com/post/2024/1/13/each-version-of-the-operating-system-is-correct-dotnet-support"
                },
                new()
                {
                    ...
                    Cover = "https://img1.dotnet9.com/site/tools/safe.png",
                    Url =
                        "https://blog.codewf.com/post/2023/9/26/simulate-scenarios-using-third-party-dotnet-libraries-for-debugging-interception-decompilation-and-compatibility-solutions-for-multiple-versions-of-one-library"
                }
            }
        };
