...
namespace CodeWF.Tool.Docs.Pages;
...
public partial class Components
{
    ...
    private string ApiGithubUri
    {
        get
        {
            ...
            return $"https://github.com/masastack/MASA.Blazor/blob/main/docs/CodeWF.Tool.Docs/wwwroot/data/apis/{Page}/{lastSegment}.json";
        }
    }

    private string ComponentGithubUri
        => $"https://github.com/masastack/MASA.Blazor/blob/main/docs/CodeWF.Tool.Docs/wwwroot/pages/{_group}/{Page}/{Culture}.md";
