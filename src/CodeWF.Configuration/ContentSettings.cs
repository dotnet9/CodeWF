...
{
    [Display(Name = "Comment provider")] public CommentProvider CommentProvider { get; set; }
    ...
    [Display(Name = "Enable comments")] public bool EnableComments { get; set; } = true;
    ...
    [Display(Name = "Enable word filter")] public bool EnableWordFilter { get; set; }

    [Display(Name = "Word filter mode")] public WordFilterMode WordFilterMode { get; set; }
