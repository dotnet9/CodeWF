...
{
    [HiddenInput] public Guid PostId { get; set; } = Guid.Empty;
    ...
    [Display(Name = "Feed Subscription")] public bool FeedIncluded { get; set; }
    ...
    [Display(Name = "Mark as outdated")] public bool IsOutdated { get; set; }
