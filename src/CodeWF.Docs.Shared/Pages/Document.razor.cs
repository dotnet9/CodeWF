using CodeWF.Docs.Shared.Shared;
...
public partial class Document : IDisposable
{
    ...
    private string GithubUri
    {
        get
        {
            ...
            {
                "Tool" =>
                    $"https://github.com/dotnet9/CodeWF/blob/main/docs/CodeWF.Tool.Docs/wwwroot/pages/{Category}/{Page}/{Culture}.md",
                "Post" or "Resource" =>
                    $"https://github.com/dotnet9/CodeWF/blob/main/src/CodeWF.{Project.ToUpperFirst()}.Docs/wwwroot/pages/{Category}/{Page}/{(string.IsNullOrWhiteSpace(SubPage) ? "" : $"{SubPage}/")}{Culture}.md",
                _ => string.Empty
            };
        }
    }
