...
namespace CodeWF.WebAPI.Infrastructure.Migrations
{
    ...
    [Migration("20230917115811_AddShortIdForBlogPost")]
    partial class AddShortIdForBlogPost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.BlogPosts.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.BlogPosts.BlogPostAlbum", b =>
                {
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.BlogPosts.BlogPostCategory", b =>
                {
                    b.Property<Guid>("BlogPostId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.BlogPosts.BlogPostTag", b =>
                {
                    b.Property<Guid>("BlogPostId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.Donations.Donation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.Links.Link", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.Privacies.Privacy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.Timelines.Timeline", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.BlogPosts.BlogPostAlbum", b =>
                {
                    ...
                    b.HasOne("CodeWF.WebAPI.Domain.BlogPosts.BlogPost", null)
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("CodeWF.WebAPI.Domain.BlogPosts.BlogPostTag", b =>
                {
                    ...
                    b.HasOne("CodeWF.WebAPI.Domain.Tags.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
