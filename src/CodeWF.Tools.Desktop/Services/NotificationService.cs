...
public class NotificationService : INotificationService
{
    ...
    {
        WindowNotificationManager notificationManager = new WindowNotificationManager(hostWindow)
        {
            Position = NotificationPosition.BottomRight, MaxItems = 4, Margin = new Thickness(0, 0, 15, 40)
        };
