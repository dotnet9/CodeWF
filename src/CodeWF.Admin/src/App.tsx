import { useDeferredValue, useEffect, useMemo, useRef, useState, type Key, type MouseEvent, type ReactNode } from "react";
import {
  Alert,
  App as AntApp,
  Button,
...
const SITE_LOGO_URL = `${import.meta.env.BASE_URL}logo.svg`;
...
function renderWorkspaceView(view: ViewKey, culture: AdminLocale, onJump: (view: ViewKey) => void, access: AdminAccess) {
  ...
  if (view === "repository") {
    ...
    return <RepositoryView canWrite={access.canWrite} />;
  }
