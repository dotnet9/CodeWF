...
public class ManifestIcon
{
    ...
    [JsonIgnore] public string SrcTemplate { get; set; }

    [JsonIgnore] public int Pixel { get; set; }
}

public static partial class ApplicationBuilderExtensions
{
    public static IApplicationBuilder UseManifest(this IApplicationBuilder app,
        Action<WebManifestMiddlewareOptions> options)
    {
