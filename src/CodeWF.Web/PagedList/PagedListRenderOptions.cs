...
public class PagedListRenderOptions
{
    ...
    /// <summary>
    ///     If set to <see cref="ItemSliceAndTotalPosition.Start" />, render an info at the beginning of the list. If set to
    ///     <see cref="ItemSliceAndTotalPosition.End" />, render the at the beginning of the list.
    /// </summary>
    public ItemSliceAndTotalPosition ItemSliceAndTotalPosition { get; set; }

    /// <summary>
    ///     A function that will render each page number when specified (and DisplayLinkToIndividualPages is true). If no
    ///     function is specified, the LinkToIndividualPageFormat value will be used instead.
    /// </summary>
    ...
    /// <summary>
    ///     An extension point which allows you to fully customize the anchor tags used for clickable pages, as well as
    ///     navigation features such as Next, Last, etc.
    /// </summary>
