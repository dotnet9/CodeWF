...
public class DetailsBySlugModel : PageModel
{
    ...
    public DetailsBySlugModel(IBlogPostService service, CodeWFDbContext dbContext, IEventBus eventBus,
    ...
    public async Task OnGet()
    {
        ...
        _eventBus.Publish("CodeWF.Web.BlogPosts.OnGet", new ReadBlogPostEvent(Slug));
    }
}