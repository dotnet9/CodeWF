...
function homeCopy(locale: Locale) {
  ...
  if (locale === "ja") {
    return {
      ...
      title: ".NET と現代的な開発を、エンジニアリングの視点で記録する",
      description: "フレームワークの深掘り、ソースコードの実践、ツールチェーン、実案件から得た知見を、再利用しやすい技術判断として整理します。",
      browsePosts: "記事を見る",
      openProjects: "プロジェクトを見る",
      searchSite: "サイト内検索",
      trustlineLabel: "サイトコンテンツの規模",
      postsMetric: "記事",
      projectsMetric: "プロジェクト",
      toolsMetric: "ツール",
      spotlightLabel: "注目の更新",
      spotlight: "最新更新",
      startEyebrow: "ここから開始",
      startTitle: "初めての訪問者に向けた読み始めの導線",
      startDescription: "最新記事、テーマ別の連載、カテゴリ別の一覧、プロジェクトの索引から目的に合う入口を選べます。",
      latestKicker: "最新記事",
      latestFallback: "最新記事",
      latestDescription: "新しい内容から読み始めます。",
      albumKicker: "テーマ",
      albumTitle: (name?: string) => `${name ?? "テーマ"}をシリーズで読む`,
      albumDescription: (count: number) => `${count} 本の記事を続けて読めます`,
      categoryKicker: "カテゴリ",
      categoryTitle: (name?: string) => `${name ?? "カテゴリ"}を一覧する`,
      categoryDescription: (count: number) => `${count} 本の記事を技術領域ごとに整理`,
      projectKicker: "プロジェクト",
      projectTitle: "オープンソースプロジェクトを見る",
  ...
  if (locale === "zh-TW") {
    return {
      ...
      description: "深入框架、源碼實踐、工具鏈與真實專案經驗，沉澱可重複使用的技術判斷。",
      browsePosts: "瀏覽文章",
      openProjects: "進入專案",
      searchSite: "全站搜尋",
      ...
      startEyebrow: "從這裡開始",
      startTitle: "新訪客的起步路線",
      startDescription: "按你的目的選入口：先看最新更新、跟著主題連讀、按分類篩選，或直接進入專案索引。",
      latestKicker: "最新文章",
      latestFallback: "最新文章",
      latestDescription: "從最近更新的內容開始。",
      albumKicker: "主題",
      albumTitle: (name?: string) => `跟著主題讀 ${name ?? "內容"}`,
      albumDescription: (count: number) => `${count} 篇文章，適合連續閱讀`,
      categoryKicker: "分類",
      categoryTitle: (name?: string) => `先看 ${name ?? "分類"}`,
  ...
  return {
    ...
    startEyebrow: "从这里开始",
    startTitle: "新用户起步路线",
    startDescription: "按你的目的选择入口：先看最新更新、跟着专题连读、按分类筛选，或直接进入项目索引。",
    latestKicker: "最新文章",
    latestFallback: "最新文章",
    ...
    categoryKicker: "分类",
    categoryTitle: (name?: string) => `先看 ${name ?? "分类"}`,
